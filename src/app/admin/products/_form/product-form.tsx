...
function VariantsSection({
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-2 mt-3 min-w-0">
          <input
            ...
            className="w-full sm:flex-1 rounded-xl border border-gray-200 px-3 py-2 text-xs font-semibold focus:border-[#1a5c14] focus:outline-none focus:ring-1 focus:ring-[#1a5c14]"
          />
          <button type="button" onClick={addCustomSize}
            className="flex items-center justify-center gap-1.5 rounded-xl bg-gray-100 px-4 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-200 transition-colors shrink-0">
      ...
      <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50/60 p-3 sm:p-4 space-y-3 max-w-full overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 pt-1 min-w-0">
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <input
              ...
              placeholder="Type color name (e.g. Maroon, Olive)…"
              className="w-full min-w-0 rounded-xl border border-gray-200 px-3 py-1.5 text-xs font-semibold focus:border-[#1a5c14] focus:outline-none bg-white"
            />
          </div>
          <button
            type="button"
            onClick={addCustomColor}
            className="flex items-center justify-center gap-1 rounded-xl bg-[#1a5c14] px-3.5 py-2 text-xs font-bold text-white hover:bg-[#103a0c] transition-colors shrink-0"
          >
